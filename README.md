...
```
git clone https://github.com/BelieveInYourselfOrg/ProjectPureCharityFEDonor.git
```
2. Navigate to the project directory:
```
cd ProjectPureCharityFEDonor
```
...
This command will start the development server and automatically open your default browser to [localhost:4100](http://localhost:4100/).

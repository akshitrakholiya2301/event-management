...
export const getIsAuthorizedForCharity = (): any => {
  return localStorage.getItem("isAuthorizedForCharity");
};
/** 
...
export const checkFileSize = (fileSize, checkSize) => {
  const fileSIzeInMb = +convertDecimalTwoPoint(fileSize / (1024 ** 2), checkSize);
  let valid = true;

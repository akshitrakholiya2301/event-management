...
import { Button, Col, Dropdown, Form, Modal, OverlayTrigger, Row, Table, Tooltip } from 'react-bootstrap';
import cancerFight from '../../../assets/images/cancer-fight.svg'


const PaymentManagemnet = (props) => {
    return (
        <>
...
export default connect(mapStateToProps, mapDispatchToProps)(PaymentManagemnet)